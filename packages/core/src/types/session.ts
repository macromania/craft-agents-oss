...
/**
 * Provider type identifier for AI provider tracking
 */
export type SessionProviderType = "claude" | "copilot";
...
export interface Session {
  ...
  createdAt: number;
  lastUsedAt: number;
  // Provider tracking (for resume compatibility)
  provider?: SessionProviderType; // Which provider created this session ('claude' | 'copilot')
