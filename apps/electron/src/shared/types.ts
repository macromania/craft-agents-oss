 ...
 */
export type RightSidebarPanel = { type: "sessionMetadata" } | { type: "files"; path?: string } | { type: "history" } | { type: "none" };
 ...
 */
export type ChatFilter = { kind: "allChats" } | { kind: "flagged" } | { kind: "state"; stateId: string } | { kind: "label"; labelId: string } | { kind: "view"; viewId: string };
 ...
 */
export type NavigationState = ChatsNavigationState | SourcesNavigationState | SettingsNavigationState | SkillsNavigationState;

/**
 * Type guard to check if state is chats navigation
 */
export const isChatsNavigation = (state: NavigationState): state is ChatsNavigationState => state.navigator === "chats";
